...
<?php $component->withAttributes([]); ?>
    ...
    <div class="panel">
        ...
        <form method="post" action="<?php echo e(route('supplier.update',$supplier)); ?>"  enctype="multipart/form-data" accept-charset="utf-8">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?> "
                                id="name" name="name" value="<?php echo e($supplier->name); ?>" required>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text"  minlength="11" class="form-control <?php echo e($errors->has('phone') ? 'is-invalid' : ''); ?> "
                                id="phone" name="phone" value="<?php echo e($supplier->phone); ?>" required>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php echo e($errors->has('address') ? 'is-invalid' : ''); ?> "
                                id="address" name="address" value="<?php echo e($supplier->address); ?>" required>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control <?php echo e($errors->has('note') ? 'is-invalid' : ''); ?> "
                                    name="note"  ><?php echo e($supplier->note); ?></textarea>
...
<?php endif; ?> 
<?php /**PATH /media/a7m6d/Disk_Data/project/laravel_PJ/Aisent/carton_sys2/resources/views/suppliers/edit.blade.php ENDPATH**/ ?>