...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('header'); ?>
        <div class="">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('New purchase invoice')); ?>
    ...
    <div class="panel">
        ...
        <!--Block Styled Form -->
        <!--===================================================-->
        <form method="post" action="<?php echo e(route('purchase.store')); ?>"  enctype="multipart/form-data" accept-charset="utf-8">
            <?php echo csrf_field(); ?>
            <div class="panel-body">
                <input type="hidden" name="type" value="purchase">
                <div class="row">
                    <div class="col-8 mb-2">
                        <label for="supplier_id"><?php echo e(__('Suppliers')); ?>*</label>
                        <select name="supplier_id" id="supplier"
                                class="form-control custom-select auto-save select" required>
                            <option value=""><?php echo e(__('Select')); ?> <?php echo e(__('Supplier')); ?></option>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control <?php echo e($errors->has('note') ? 'is-invalid' : ''); ?> "
                                    name="note" value="<?php echo e(old('note')); ?>" ></textarea>
...
<?php endif; ?> 
<?php /**PATH /media/a7m6d/Disk_Data/project/laravel_PJ/Aisent/carton_sys2/resources/views/invoice/purchase/create.blade.php ENDPATH**/ ?>