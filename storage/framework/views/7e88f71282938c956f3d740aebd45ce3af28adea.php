...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('header'); ?>
        <div class="">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Create Customers')); ?>
    ...
    <div class="panel">
        ...
        <form method="post" action="<?php echo e(route('customer.store')); ?>"  enctype="multipart/form-data" accept-charset="utf-8">
            <?php echo csrf_field(); ?>
            ...
            <div class="panel-boody text-center">
                <button class="btn btn-primary rounded-0 my-2" type="submit"><?php echo e(__('Save')); ?></button>
            </div>
        </form>
...
<?php /**PATH /media/a7m6d/Disk_Data/project/laravel_PJ/Aisent/carton_sys2/resources/views/customers/create.blade.php ENDPATH**/ ?>