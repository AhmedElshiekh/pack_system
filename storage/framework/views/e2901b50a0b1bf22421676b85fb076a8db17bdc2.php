...
} elseif ($_instance->childHasBeenRendered('wTLxLFo')) {
    $componentId = $_instance->getRenderedChildComponentId('wTLxLFo');
    $componentTag = $_instance->getRenderedChildComponentTagName('wTLxLFo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wTLxLFo');
} else {
    $response = \Livewire\Livewire::mount('navigation-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('wTLxLFo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
