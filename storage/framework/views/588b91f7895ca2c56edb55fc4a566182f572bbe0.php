...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('title', __('Sales')); ?>
    <?php $__env->startSection('header'); ?>
        <div class="">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Sales invoices')); ?>

            </h2>
        </div>
        <div class="">
            <a href="<?php echo e(route('sales.create')); ?>" class="btn btn-sm btn-outline-info rounded-0"><i class="fa fa-plus"></i> <?php echo e(__('Create a Sales invoice')); ?></a>
        </div>
    ...
    <div class="panel">
        <div class="panel-heading">
            <form  method="post" action="<?php echo e(route('sales.filter')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('sales.show', $invoice)); ?>"  class="btn btn-sm btn-success fa fa-eye"></a>
                                <a href="" onclick="removeUser('<?php echo e($invoice->number); ?>', '<?php echo e(route('invoice.sales.delete', $invoice)); ?>', event)"  class="btn btn-sm btn-danger fa fa-trash-o"></a>
                            </td>
                        </tr>
...
<?php endif; ?> <?php /**PATH /media/a7m6d/Disk_Data/project/laravel_PJ/Aisent/carton_sys2/resources/views/invoice/sales/index.blade.php ENDPATH**/ ?>