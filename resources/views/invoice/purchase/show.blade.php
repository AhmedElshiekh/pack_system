                                ...
                                <div class="table-responsive">
                                    <table class="table table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center border"><strong>{{__('Item Name')}}</strong></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('purchase.paid',[$locale, $invoice])}}" enctype="multipart/form-data" file="true">
                        @csrf
